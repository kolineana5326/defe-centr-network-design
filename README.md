...
## Project Overview
This project simulates the network design for a new three-story National Defense Command and Operations Center. The goal was to build a robust, secure, and redundant network infrastructure from scratch to support 500 personnel.
...
The base private network -`172.16.0.0/16` IP space, the network is segmented into VLANs to ensure operational isolation.
...
| Secure Data Center | 3 | 60 | 172.16.4.128/25 |
...
* **Routing Protocol:** **OSPF** (Open Shortest Path First) is configured on all routers and switches for dynamic path selection and fast failover.
